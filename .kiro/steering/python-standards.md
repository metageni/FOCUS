...
from focus_app import __version__ # group 11: local from...import
from focus_app.focus import (     # multi-symbol: parenthesised, one per line
    profile,
    aggregate_level,
)
```
...
## CLI separation
- `focus.py` = core logic only, no CLI code
